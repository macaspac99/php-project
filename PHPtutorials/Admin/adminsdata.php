...
<!-- Add -->
    <div class="modal fade" id="adminaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="new folder/admininsertcode.php" method="POST">
  ...
  <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="new folder/adminupdatecode.php" method="POST">
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="new folder/admindeletecode.php" method="POST">
...
<div class="tableadmin">
    ...
    $query2 = "SELECT * FROM tbadmin";
    $query_run2 = mysqli_query($connection, $query2);
    ?>
    <h1>Welcome ADMIN</h1>
    <h2>Admins Database</h2>
      <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#adminaddmodal">
                        ADD DATA
                    </button>
                    <a class="btn btn-secondary" href="usersdata.php" role="button">USERS DATABASE</a>
    ...
    <table id="admindatatable" class="table table-dark table-striped">
  <thead>
    <tr>
      <th scope="col">ID</th>
